  ...
  return (
    <div className='min-h-screen px-4 lg:py-24 py-28 flex lg:flex-row flex-col items-center justify-around relative gap-20 drop-shadow-lg overflow-hidden'>
      ...
      <motion.div
        ...
        <Image src="/fabi2.jpg" alt="Doutor Fabricio" width={638} height={850} className="w-full h-full max-w-[638px] max-h-[851px] rounded hover:scale-105 duration-300 transition-all select-none shadow-lg hover:shadow-2xl object-cover " />
        <motion.div
