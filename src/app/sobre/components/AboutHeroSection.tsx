...
export default function AboutHeroSection() {
  return (
    <div className='min-h-screen px-4 pt-36 lg:pt-40 pb-16 lg:pb-24 flex lg:flex-row flex-col items-center justify-around relative gap-12 lg:gap-20 drop-shadow-lg overflow-hidden'>
