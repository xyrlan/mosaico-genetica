  ...
  return (
    <div className="lg:max-w-lg z-20">
      <div className='flex justify-center max-lg:hidden'>
        <Image src="/mosaicoazul.png" alt="Mosaico Genética" width={400} height={400} priority className="h-auto w-auto max-2xl:max-h-[250px] select-none" />
      </div>
      <h1 className='sr-only'>Mosaico Genética Médica</h1>
      <p className="text-base lg:text-xl 2xl:text-2xl font-medium text-gray-700 max-w-2xl text-center text-balance tracking-wide mt-5 max-lg:px-4">
