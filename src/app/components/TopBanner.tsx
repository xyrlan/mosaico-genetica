...
import TopBannerLinksComponents from './topbannerLinksCompoent';
      ...
      <div className=" mx-auto flex flex-wrap items-center justify-start lg:justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            rel="noreferrer"
            target="_blank"
            className="flex items-center gap-2 text-gray-700 hover:text-gray-700/75 transition-colors"
          >
            ...
            <span className="text-xs font-medium text-gray-600">61 99857-0759</span>
          </a>
         
        </div>
        
        {/* <AgendarConsulta /> */}
        <TopBannerLinksComponents />
