...
const AboutSection = () => {
  return (
    <section id="nosso-especialista" className="min-h-screen flex items-center relative py-24">
      <Image src={'/background.png'} width={1000} height={1000} alt="background" className="absolute bottom-0 left-0 z-0  opacity-40" />
      <div className="container mx-auto z-10">
        <div className=" flex md:flex-row flex-col justify-between items-center gap-10">

          <Image src="/sapiens.png" alt="sapiens-picture" width={700} height={700} className="w-auto h-auto object-contain drop-shadow-lg hover:scale-105 duration-300 transition-all" />

          <div className="flex items-center flex-col w-full p-10">
            <h2 className="text-4xl font-semibold text-center">
              Atendimento onde você estiver
            </h2>
            <h3 className="text-2xl font-semibold text-center mt-8 inline-flex gap-2">
              <Wifi />
              Online
            </h3>
        ...
        <div className="flex md:flex-row flex-col justify-between items-center gap-10">
          ...
          <div className="relative w-full h-full rounded-full shadow-lg hover:shadow-2xl scale-[80%] overflow-hidden duration-300 transition-all ">
            <Image src="/Fabricio.jpg" alt="Especialista" width={700} height={700} className="w-full h-full hover:scale-105 duration-300 transition-all  " />
          </div>
