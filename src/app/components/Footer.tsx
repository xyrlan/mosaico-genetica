    ...
    <footer className="bg-[#cbe7ed] border border-gray-300 ">
      <div className="mx-auto max-w-5xl px-4 py-4 lg:py:8 2xl:py-16 sm:px-6 lg:px-8">
        ...
        <ul className="mt-12 flex justify-center gap-6 md:gap-8">
          ...
          <li>
            ...
            >
              ...
              <Image src={'/lintree.png'} width={38} height={38} alt='linktree' className=' duration-300 hover:saturate-150 transition-all' />
            </Link>
          </li>
        ...
        <div className='flex flex-col items-center my-6 gap-2'>
          ...
          <p className="text-xs text-gray-500 ">Desenvolvido por <Link href={'/'} className='underline decoration-2 hover:decoration-3 hover:decoration-red-600 hover:text-red-600 duration-300 transition-all'>xyrlan</Link></p>
        </div>
      </div>
    </footer>
  )
